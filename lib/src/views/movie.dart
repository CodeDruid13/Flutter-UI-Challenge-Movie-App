...
import 'package:movie_today/src/views/base_view.dart';
...
class _MoviePageState extends State<MoviePage> {
  ...
  Widget getPostsUi(List<Poster> posts) => Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            String jsonString = json.encode(posts[index].toJson());
